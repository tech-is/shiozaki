...
<form method= 'post'>
    <div>
        ...
        <input type= 'text' id= 'view_name' name= 'view_name' value="<?php 
        if(!empty($message_data['view_name'])){ echo $message_data['view_name'];} ?>"　disabled>
    </div>
    <div>
        <label for = 'message'>ひとことメッセージ</label>
        <textarea id= 'message' name= 'message' disabled><?php 
        if (!empty($message_data['message'])){ echo $message_data['message'];} ?></textarea>
    </div>
