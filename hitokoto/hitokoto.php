...
if(!empty($_POST['btn_submit'])){
    ...
    //     エラー番号 '.$mysqli->connect_errno.' : '.$mysqli->connect_error;
    // }else{
        //データベースの処理
    ...
    //prepareメソッドでSQLをセット
        ...
        $sth = $dbh->prepare("INSERT INTO message (view_name, message, post_date) VALUES (:view_name, :message, :now_date)");
        //bindValueメソッドでパラメータをセット

        $sth->bindValue(":view_name", $_POST['view_name'] );
        $sth->bindValue(":message", $_POST['message'] );
        $sth->bindValue(":now_date", $now_date );
        //executeでクエリを実行
...
$sth = $dbh->prepare("SELECT * FROM message ORDER BY post_date DESC");
...
<form method= 'post'>
    <div>
        ...
        <input type= 'text' id= 'view_name' name= 'view_name' value="<?php if(!empty($_SESSION['view_name'])){echo $_SESSION['view_name'];} ?>">
    </div>
    <div>
...
<?php if(true || !empty($message_array)):?>
